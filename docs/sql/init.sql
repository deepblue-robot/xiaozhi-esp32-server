...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='租户用户';



CREATE TABLE `ai_tenant_agent` (
  `id` bigint NOT NULL COMMENT 'id',
  ...
  `creator` bigint DEFAULT NULL COMMENT '创建者'
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='租户智能体关联表';
...
alert table ai_device add COLUMN  `tenant_id` bigint NOT NULL COMMENT '租户ID' AFTER `id`;
